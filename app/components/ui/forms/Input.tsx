  ...
  return (
    <div className="relative w-full">
      ...
      <input
        ...
        placeholder=" "
        type={type}
        className={`peer w-full rounded border-2 bg-white p-4 pt-6 font-light outline-none transition disabled:cursor-not-allowed disabled:opacity-70 ${
          formatPrice ? "pl-9" : "pl-4"
        }
        ${errors[id] ? "border-rose-500" : "border-netural-300"} 
