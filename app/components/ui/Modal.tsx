    ...
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto overflow-x-hidden bg-neutral-800/70 outline-none transition focus:outline-none">
        <div className="xl:md-2/5 relative mx-auto my-6 h-full w-full md:h-auto md:w-4/6 lg:h-auto lg:w-3/6">
          ...
          >
            <div className="translate relative flex h-full w-full flex-col rounded border-0 bg-white shadow-lg outline-none focus:outline-none md:h-auto lg:h-auto">
              {/* HEADER */}
              <div className="relative flex items-center justify-center rounded-t border-b-[1px] p-6">
                <button className="absolute left-9 border-0 p-1 transition hover:opacity-70">
                  <X size="22" onClick={handleOnClose} />
                </button>
